...
if (isset($_POST['Check_Cert_Employee'])) {
  ...
  certsq.progress, certsq.calification, certsq.attempts , testtaken.date
    ...
    WHERE certsq.progress >= 150 AND active = 1 AND
            certsq.idEmpleado ='.$idEmpleado ;
        ...
        certsq.progress, certsq.calification, certsq.attempts, testtaken.date
          ...
          WHERE certsq.progress >= 150 AND active = 1' ;
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <button class="btn btn-warning" formaction="Admin_MainPage.php" name="Exchange_Op" type="submit">
