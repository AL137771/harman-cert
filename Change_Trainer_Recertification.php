...
if (isset($_POST['change_Recertification_Trainer'])) {
  ...
  <?php include "Trainer_Template.php"; ?>
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <button class="btn btn-success" id="menu-toggle">CAMBIAR RECERTIFICACION DE ENTRENADOR</button>
      ...
      <form action='' method="post">
                <div class='form-group container'>
                        <div class='row'>
                            ...
                            <div class='col-md-3'></div>
                                <select class='form-control col-md-6 chosen' name="trainer" id="trainer">
            ...
            <button class="col-sm-6 btn btn-dark" formaction="Trainer_RecertPage.php" name='Change_Trainer_Recertification'type="submit">Cambiar</button>
                </div>
<br><br>
