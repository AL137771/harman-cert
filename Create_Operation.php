  ...
  <?php include "Admin_Template.php"; ?>
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <button class="btn btn-info" id="menu-toggle">CREAR OPERACION</button>
      ...
      <form action='' method="post">
                ...
                <div class='row'>
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="">NOMBRE OPERACION</span>
                        </div>
                        <input type="text" name='nameOperation' class="form-control">
                        </div>            
                ...
                <div class='row'>
                         ...
                         <div class='col-md-3'></div>
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="">COMPLEJIDAD</span>
                            </div>
                ...
                <button class="col-sm-6 btn btn-dark" formaction="Visualize_Operations.php" name='Operation_Complete' type="submit">Guardar datos</button>
                </div>
