...
$date = date('Y-m-d H:i:s');
    ...
    if(isset($_POST['sq3'])){    
        ...
        recertsq.progress, recertsq.calification, recertsq.attempts, retesttaken.date
          ...
          WHERE trainers.idTrainer = '.$_SESSION['id'].' AND recertsq.progress >= 37.5 AND active = 1' ;
  ...
  <?php include "Trainer_Template.php"; ?>
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
        <button class="btn btn-success" id="menu-toggle"></i>RECERTIFICACIONES COMPLETADAS</button>
                                ...
                                <?php
                                    ...
                                    echo  '<td>'.$data['lastUp'].'</td>';              
                                            ...
                                            if ($data['calification'] >= 8) {
                                              ...
                                              echo  '<td><button type="submit" formaction="Apply_Test_Re.php" name="Apply_Test" 
