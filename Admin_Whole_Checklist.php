...
$query = 'SELECT turno.nameTurno, checklist_dates.idTrainer, trainers.nameTrainer, checklist_dates.idArea, 
        area.nombreArea, checklist.idOperacion, operacion.nOperacion, 
        checklist.idEmpleado, checklist.nameEmpleado, checklist_dates.dateRegistro, checklist.tress 
FROM checklist
                          ...
                          <tr>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    echo '<td><input type="hidden" name="idTrainer" value='.$data['idTurno'].'>'.$data['nameTurno'].'</td>';;
