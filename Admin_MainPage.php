  ...
  <?php include "Admin_Template.php"; ?>
    ...
    <div id="page-content-wrapper">
      ...
      <select  class='form-control col-md-4 chosen' name="area" id="area">
            ...
            <button type="submit" formaction="Admin_MainPage.php" name="Search" class="col-md-2 btn btn-primary">Buscar</button>
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    echo  '<td><button type="submit" formaction="Delete.php" name="Bin_Certification" 
                                    class="btn btn-outline-danger">
                                    <i class="fas fa-recycle"></i></i></button></td>';
