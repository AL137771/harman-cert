        ...
        <form action='' method="post">
          <div class='form-group container'>
                ...
                echo '<div class="row">
                        <div class="input-group">
                          <div class="input-group-prepend">'; 
                                echo '<span class="input-group-text" id="">OP '.$cont.'</span>
                          </div>
                                    <input type="hidden" name="idAnswer_'.$cont.'" value='.$row2['idAnswer'].'>
                                    <input  type="text" name="opcion_'.$cont.'" id="opcion_1" 
                          ...
                          ';
                            ...
                            <div class='row'>
                              ...
                              <div class='row'>
                                    ...
                                    <button class="col-sm-6 btn btn-dark" formaction="Visualize_Test.php" name='Update_Question' type="submit">Guardar datos</button>
                              </div>
