...
if (isset($_POST['Record_Certification'])) {
    $idCertification = $_POST['idCertification'];
    $nameEmpleado = $_POST['nameEmpleado'];
        $query = 'SELECT hrsregistered.fechaRegist, area.nombreArea, hrsregistered.idTrainer, trainers.nameTrainer, hrsregistered.hourRegistered, hrsregistered.idEmpleado, empleados.nameEmpleado
        FROM hrsregistered
        INNER JOIN empleados ON empleados.idEmpleado = hrsregistered.idEmpleado
        INNER JOIN trainers ON trainers.idTrainer = hrsregistered.idTrainer
        INNER JOIN certsq on certsq.idCertification = hrsregistered.idCertification
          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <?php
              ...
              if ($_SESSION['typeUser'] == 1) {
               ...
               <button class="btn btn-danger" formaction="Trainer_MainPage.php" type="submit">
               <i class="fas fa-undo-alt"></i></button>
               </form>';
              }
              elseif ($_SESSION['typeUser'] == 2) {
                echo  '<form action="" method="POST">
                <button class="btn btn-danger" formaction="Admin_MainPage.php"  type="submit">
                <i class="fas fa-undo-alt"></i></button>
                </form>';
              }
