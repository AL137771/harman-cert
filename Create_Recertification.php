...
if (isset($_POST['Create_recert_From_Checklist'])) {
  echo "";
  $idArea = $_POST['idArea'];
  ...
  $query = 'SELECT recertsq.idCertification, recertsq.idTrainer, trainers.nameTrainer,
                      recertsq.idArea, area.nombreArea, recertsq.idOperacion, operacion.nOperacion,
                      recertsq.idComplejidad,   complejidad.tipoComplejidad, 
  ...
  <?php include "Trainer_Template.php"; ?>
    ...
    <form action='' onsubmit="return checkForm(this);" method="post">
        ...
        <div class='form-group container' >
                ...
                <button class="col-sm-3 btn btn-primary" formaction='Tracing_Recertification.php' name='Send_Area_Info' type="submit"><i class="fas fa-sign-in-alt"></i></button>
                </div>
