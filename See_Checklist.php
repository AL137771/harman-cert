...
$query = 'SELECT idTurno from trainers where idTrainer ='.$trainer;
    ...
    $row = $i ->fetch_assoc();
    $idTurno = $row['idTurno'];
$query = 'SELECT DISTINCT checklist_dates.idArea, area.nombreArea, CAST(checklist_dates.dateRegistro AS DATE) as DATE
      FROM checklist
        ...
        WHERE trainers.idTurno ='.$idTurno.' AND CAST(checklist_dates.dateRegistro AS DATE) 
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    echo  '<td>
                                    <button type="submit" 
                                    formaction="Watch_Selected_Checklist.php" 
