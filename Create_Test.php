...
if(isset($_SESSION['test_restriction'])){
  echo "<script type='text/javascript'>
          alert('" . $_SESSION['test_restriction'] . "');
        </script>";
  //to not make the error message appear again after refresh:
  unset($_SESSION['test_restriction']);
}
    ...
    <div id="page-content-wrapper">
      ...
      <form action='' method="post">
                ...
                <select required class='form-control col-md-6 chosen' name="idOperacion" >
                    ...
                    <div class='row'>
                <div class='col-sm-3'></div>
                <select required class='form-control col-md-6 chosen' name="cantA" >

                        <option value="">CANTIDA DE PREGUNTAS</option>
                   <?php
                   for ($i=0; $i < 15 ; $i++) { 
                ...
                <div class='col-sm-3'></div>    
                <button class="col-sm-6 btn btn-dark" formaction="Add_Questions_To_Created_Test.php" name='Create_Test' type="submit">Guardar datos</button>
                </div>
