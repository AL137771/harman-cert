...
if (isset($_POST['Add_Answers'])) {
 ...
 for ($i=0; $i < $nquestions; $i++) { 
   ...
   $query = 'INSERT INTO espansweredtest (idQuestion, idCertification,  idAnswer) 
                   VALUES ("'.$questions[$i].'",'.$idCertification.',"'.$answer[$i].'")';
 ...
 $query = 'SELECT espansweredtest.idCertification, SUM(answer.value) as total
           FROM espansweredtest
           INNER JOIN answer ON answer.idAnswer = espansweredtest.idAnswer
           WHERE espansweredtest.idCertification ='.$idCertification;
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    echo  '<td><input type="hidden" name="area" value="'.$data['idTrainer'].'">'.$data['nameTrainer'].'</td>';
                                    ...
                                    echo  '<td><button type="submit" formaction="Delete.php" name="Delete_Cert_SP" 
                                    class="btn btn-outline-danger">
                                    <i class="fas fa-trash"></i></i></button></td>';
